...
subtitle: "Elaborado por Ana López, Matthias Pelz, Jefferson Salas"
output: 
...
icono_activos <- 'fas fa-user-circle'
icono_recuperados <- 'fas fa-user-minus'
...
icono_adultom <- 'fas fa-wheelchair'
#--------------- Otros parámetros -----------------
